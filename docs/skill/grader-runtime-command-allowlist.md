...
- The safer long-term model keeps the official grading execution path on fixed runtime profiles from `server/grading/runtime-profiles.ts`.
...
- Revisit this allowlist model before keeping the app open beyond a temporary workspace/demo window.

...
- Official submit should give immediate user feedback:
  - acknowledge that grading has started
  - update the editor view when grading completes
...
- Use breadcrumbs on detail pages to make navigation back to the list obvious.

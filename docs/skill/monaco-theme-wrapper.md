...
Use `components/editor/monaco-code-editor.tsx` for every Monaco instance. It owns the Codetice dark theme, watches the root `dark` class, and exposes `disabled` for read-only viewers such as submitted code.
